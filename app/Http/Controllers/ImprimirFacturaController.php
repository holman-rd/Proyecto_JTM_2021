...
class ImprimirFacturaController extends Controller
{
    ...
    public function imprimir(){
        ...
        $trabajo_fecha=DB::select('select c.nombre,c.no_documento,c.telefono,t.fecha_inicio from cliente as c join dispositivo as d on (c.id_cliente=d.cliente_id_cliente) join trabajo as t on (d.serial=t.dispositivo_serial) GROUP by c.nombre,c.no_documento,c.telefono,t.fecha_inicio');

        $pdf=\PDF::loadView('pdf');
        return $pdf->dowload('factura.pdf');
    }
