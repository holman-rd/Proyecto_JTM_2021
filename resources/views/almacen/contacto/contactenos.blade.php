...
@section('contenido')
    ...
    <section class="section section-lg text-center bg-default">
        <div class="container">
            ...
            <div class="row row-50">
                ...
                <div class="col-md-5 col-lg-3">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1984.6113221238293!2d-73.02291045310751!3d5.824197517657017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e6a3f6b69af3157%3A0x170543af546b2b3b!2sCl.%2025%20A%2C%20Duitama%2C%20Boyac%C3%A1!5e0!3m2!1ses!2sco!4v1619238604408!5m2!1ses!2sco"
                        width="250" height="250" style="border: 20px;;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            {!! Form::open(['url' => 'almacen/contacto', 'method' => 'POST', 'autocomplete' => 'off']) !!}
            {{ Form::token() }}
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-md-0">
                        <input class="form-control" id="phone" name="phone" type="number" placeholder="Telefono *"
                ...
                <div class="col-md-6">
                    <div class="form-group form-group-textarea mb-md-0">
                        <textarea class="form-control" id="message" name="message" placeholder="Sugerencia o queja *"
